...
public class GuiMIPS {
	...
	private void initialize() {
		...
		btnPlay.setIcon(new ImageIcon(GuiMIPS.class.getResource("/img/small/Play16.gif")));
		panel.add(btnPlay);
		JButton nextClock = new JButton(new ImageIcon(GuiMIPS.class.getResource("/img/small/FastForward16.gif")));
		panel.add(nextClock);
		
		JButton btnNewButton = new JButton("");
		btnNewButton.setIcon(new ImageIcon("C:\\Users\\Wanderson\\Dropbox\\Eclipse Projects\\MIPSSimulation\\src\\img\\small\\Pause16.gif"));
